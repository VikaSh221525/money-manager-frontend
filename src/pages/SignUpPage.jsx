                ...
                <div className='flex-1 flex items-center justify-center lg:justify-start'>
                    <div className='w-full max-w-md'>
                        ...
                        <div className='mb-8'>
                            ...
                            <p className='text-gray-600'>Join us to manage your finances effortlessly</p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className='space-y-5'>
                            ...
                            <div className='form-control'>
                                ...
                                <input
                                    ...
                                    className={`input input-bordered w-full bg-white focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all ${errors.name ? 'input-error' : ''}`}
                                    {...register('name', {
                        ...
                        <div className='mt-6 text-center'>
                            <p className='text-gray-600'>
                                ...
                                <Link to='/' className='text-primary font-semibold hover:underline transition-all'>
                                    Log In
                                </Link>
                            </p>
                        </div>
